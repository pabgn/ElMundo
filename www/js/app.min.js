!function(o,a){"use strict";a.app=o.module("em",["ionic","ionic.contrib.ui.cards"]).run(["$ionicPlatform",function(o){o.ready(function(){a.cordova&&a.cordova.plugins.Keyboard&&cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),a.StatusBar&&StatusBar.styleDefault()})}]).value("endpoint","http://localhost:3001").value("filesEndpoint","http://localhost:3001/file/")}(angular,window);
